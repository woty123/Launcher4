...
public class LauncherProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        System.out.println("wbzhang  ----   do querying");
        // 通过解析一个uri来进行匹配，而不是通过UriMatcher类
    ...
    synchronized public void loadDefaultFavoritesIfNecessary() {
        ...
        // 第一次运行的时候  DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED  为true，当运行结束后会移除DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            if (!convertDatabase(db)) {
                System.out.println("wbzhang ------  setFlagToLoadDefaultWorkspaceLater  invoked???");
        ...
        private boolean convertDatabase(SQLiteDatabase db) {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                System.out.println("wbzhang   -----   cursor:" + converted);
                try {
                    System.out.println("wbzhang   ----- copyFromCursor invoked!");
            ...
            System.out.println("wbzhang   -----   converted:" + converted);
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            System.out.println("wbzhagn   ---  oldVersion:" + oldVersion + "  newVersion:" + newVersion);
        ...
        private int loadFavorites(SQLiteDatabase db, int workspaceResourceId) {
            ...
            final File defaultWorkspaceConfigFile = new File(
                    "system/media/rkfactory/default_workspace.xml");
            System.out.println("wbzhang ---------------exist:" + defaultWorkspaceConfigFile.exists());
            Log.d("TAG", "----------found " + defaultWorkspaceConfigFile.exists());
            if (defaultWorkspaceConfigFile.exists()) {
                Log.d("TAG", "found " + defaultWorkspaceConfigFile);

                final LauncherProvider.DatabaseHelper l_databasehelper = this;

                LauncherConfigXmlFileParser configParser =
                        new LauncherConfigXmlFileParser(mContext,
                                new LauncherConfigXmlFileParser.LauncherProviderInterface() {
                                    public void deleteId(SQLiteDatabase db, long id) {
                                        LauncherProvider.deleteId(db, id);
                                    }

                                    public long generateNewId() {
                                        return l_databasehelper.generateNewId();
                                    }
                                    ...
                                    public long dbInsertAndCheck(SQLiteDatabase db, String table,
                                            String nullColumnHack, ContentValues values) {
                                        return LauncherProvider.dbInsertAndCheck(l_databasehelper,
                                                db, table, nullColumnHack, values);
                                    }
                                });
                return configParser.loadFavorites(db, defaultWorkspaceConfigFile);
            ...
            try {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    // res/values/attrs.xml中定义的 declare-styleable  Name为Favorite
                    TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.Favorite);

                    long container = LauncherSettings.Favorites.CONTAINER_DESKTOP;
                    if (a.hasValue(R.styleable.Favorite_container)) {
                        // 如果自定义了container则使用自定义的container
                    ...
                    System.out.println("wbzhang   -------   now Name " + name);
        ...
        private boolean addSearchWidget(SQLiteDatabase db, ContentValues values) {
            ...
            return addAppWidget(db, values, cn, 4, 1, null, null);
        }

        private boolean addClockWidget(SQLiteDatabase db, ContentValues values) {
            ComponentName cn = new ComponentName("com.android.alarmclock",
                    "com.android.alarmclock.AnalogAppWidgetProvider");
            return addAppWidget(db, values, cn, 2, 2, null, null);
        }
        ...
        private boolean addAppWidget(XmlResourceParser parser, AttributeSet attrs, int type,
            ...
            if (hasPackage) {
                ...
                return addAppWidget(db, values, cn, spanX, spanY, extras,packageName.trim());
            }
        ...
        private boolean addAppWidget(SQLiteDatabase db, ContentValues values, ComponentName cn,
                int spanX, int spanY, Bundle extras,String packageName) {
            ...
            try {
                ...
                if(packageName != null && packageName.trim().equals("com.android.gallery3d")){
                	Uri galleryWidgetUri = Uri.parse("content://com.android.gallery3d.widget.provider");
                	ContentValues galleyValues = new ContentValues();
                	galleyValues.put("appWidgetId", appWidgetId);
                	galleyValues.put("widgetType", 1);
                	mContext.getContentResolver().insert(galleryWidgetUri, galleyValues);
                }
