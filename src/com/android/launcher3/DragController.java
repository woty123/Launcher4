...
public class DragController {
    ...
    private final Vibrator mVibrator;   // 振动器

    // temporaries to avoid gc thrash  临时存储
    ...
    private VelocityTracker mVelocityTracker;  // 速度跟踪的意思。我们可以获得触摸点的坐标，根据按下的时间可以简单的计算出速度的大小。
